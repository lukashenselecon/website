...
WPS = [
 ...
 dict(y="2026", t="Mitigating the Consequences of Job Loss in Lower-Income Countries: Evidence from Ethiopia",
  ...
  v="IZA Discussion Paper 18537, superseded by the April 2026 draft",
  vz="IZA 讨论稿 18537，已由 2026 年 4 月稿替代",
 ...
 dict(y="2026", t="Feedback, Confidence and Job Search Behavior",
  ...
  v="IZA Discussion Paper 17761, superseded by the March 2026 draft",
  vz="IZA 讨论稿 17761，已由 2026 年 3 月稿替代",
 ...
 dict(y="2026", t="From Followers to Leaders: The Career Impact of High-quality Managers",
  a_en="Yuyu Chen &amp; Xinjue Yao", a_zh="与 Yuyu Chen、Yao 合著",
 ...
 dict(y="2025", t="Wage Information and Applicant Selection",
  ...
  v="IZA Discussion Paper 18220", vz="IZA 讨论稿 18220",
 ...
 dict(y="2025", t="Mutual Knowledge of Social Norms and Political Behavior",
  ...
  v="IZA Discussion Paper 17748", vz="IZA 讨论稿 17748",
...
WIP = [
 ...
 dict(y="", t="Do Labor Market Frictions Reduce Employment in Low-Income Countries? Experimental Evidence from Ethiopia",
  a_en="Stefano Caria, Pieter Gautier, Francesco Losma &amp; Marc Witte", a_zh="与 Caria、Gautier、Losma、Witte 合著",
  v="Ethiopia &middot; fieldwork underway", vz="埃塞俄比亚 · 田野工作进行中", links=[]),
 dict(y="", t="When, Not How Much: Work-Time Preferences and the Value of Schedule Changes",
  a_en="Haoran He, Qian Weng &amp; Songyu Yu", a_zh="与 He、Weng、Yu 合著",
  v="China &middot; analysis underway", vz="中国 · 数据分析中", links=[]),
 dict(y="", t="AI Adoption and Gender: Experimental Evidence on the Role of Competition",
  a_en="Yiting Chen, Xiting Cui &amp; Juanjuan Meng",
  a_zh="与 Yiting Chen、Xiting Cui、Juanjuan Meng 合著",
  v="", vz="", links=[]),
