...
PUBS = [
 dict(y="2026", t="Formalized Employee Search and Labor Demand",
  ...
  ab="Firms often use social networks to find workers, limiting the pool of potential applicants. We conduct a field experiment subsidizing firms&rsquo; formal vacancy posting. The subsidies increase non-network employee search and shift vacancies towards high-skilled positions. Post-treatment, firms continue searching for high-skilled workers despite reverting to network-based search. This change in skill requirements does not increase vacancy posting or hiring, suggesting substitutability between workers of different skill levels. Finally, we experimentally show that information asymmetries about applicants&rsquo; skills do not limit firms&rsquo; formal search. Our results highlight that exposure to different labor market segments can permanently change firms&rsquo; labor demand.",
 ...
 dict(y="2021", t="Does Party Competition Affect Political Activism?",
  ...
  links=[("open access","开放获取","https://doi.org/10.1086/712140"),
...
WPS = [
 dict(y="R&amp;R", yz="修改重投", t="Designing Severance Insurance: Theory and Evidence from Ethiopia",
  ...
  v="Conditionally accepted, Journal of Development Economics", vz="有条件接收，Journal of Development Economics",
 ...
 dict(y="R&amp;R", yz="修改重投", t="Jobseekers&rsquo; Beliefs about Comparative Advantage and (Mis)Directed Search",
  a_en="Andrea Kiss, Rob Garlick &amp; Kate Orkin", a_zh="与 Kiss、Garlick、Orkin 合著",
  v="Revise and resubmit, AEJ: Applied", vz="修改重投，AEJ: Applied",
 ...
 dict(y="2026", t="Feedback, Confidence, and Job Search Behavior",
  a_en="Tsegay Tekleselassie, Marc Witte, Jonas Radbruch &amp; Ingo Isphording", a_zh="与 Tekleselassie、Witte、Radbruch、Isphording 合著",
 ...
 dict(y="2026", t="From Followers to Leaders: The Career Impact of High-quality Managers",
  a_en="Yuyu Chen &amp; Yang Yao", a_zh="与 Chen、Yao 合著",
 ...
 dict(y="2025", t="Wage Information and Applicant Selection",
  ...
  v="IZA Discussion Paper 18220 &middot; September 2025 update", vz="IZA 讨论稿 18220 · 2025 年 9 月更新",
